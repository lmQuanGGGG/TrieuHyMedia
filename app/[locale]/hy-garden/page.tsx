  ...
  return <>
    ...
    <section className="hy-hero">
      <div className="site-container hy-hero-grid">
        ...
        <figure className="hy-hero-image"><video autoPlay muted loop playsInline preload="metadata" poster="/telegram-media?asset=coconut-coffee"><source src="/telegram-media?asset=hy-garden-hero-video" type="video/mp4" /></video></figure>
      </div>
    </section>
